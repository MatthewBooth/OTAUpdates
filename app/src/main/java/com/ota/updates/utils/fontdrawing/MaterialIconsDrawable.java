...
public class MaterialIconsDrawable extends Drawable implements App {
    ...
    public MaterialIconsDrawable(int icon, int sizeDpi, int color,
        ...
        Typeface font = Typeface.createFromAsset(context.getAssets(), MATERIAL_ICONS);
    ...
    public static class Builder {
        ...
        public MaterialIconsDrawable build() {
            return new MaterialIconsDrawable(icon, sizeDpi, color, antiAliased, fakeBold,
